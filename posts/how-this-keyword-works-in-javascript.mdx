...
I am assuming that you guys know what the "window" object is, because the "_this_" keyword is all revolving around objects and things like that so if you don't please learn about it here or anywhere else and come back

Now when you type in your console

<!-- {/* <CodeHighlight>this === window; // true</CodeHighlight> */} -->
