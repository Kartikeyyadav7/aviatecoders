...
seoTitle: Many developers get confused or don't understand the basics of call, bind, and apply, in this article, you will understand everything related to call, bind and apply
isPublished: true
publishedOn: "2021-04-10"
coverImage: "/blog/what-is-call-bind-apply-in-javascript/cover.png"
...
I have used the call and apply method on the function greeting, and the output of these will be _hello_
...
What I have done here is that I have defined an object named student1 and given name and percent and also an increment method to it, what the increment method does is that it increments the percent whenever the method is called( if you don't know about the "this" keyword please refer to [this](https://www.aviatecoders.com/javascript/how-this-keyword-works-in-javascript) article
